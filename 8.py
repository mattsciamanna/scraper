...
# Proxy Server
PROXY = "172.246.244.167:8800" # IP:PORT or HOST:PORT
# file directory
fileDir = os.path.dirname(os.path.realpath('__file__'))
#For accessing the file in a folder contained in the current folder
readfile = os.path.join(fileDir, 'fifteengroups/focal8.csv')
writefile = os.path.join(fileDir, 'fifteenouts/' + 'renamemeto_focal8' + str(today()) + '.csv')
